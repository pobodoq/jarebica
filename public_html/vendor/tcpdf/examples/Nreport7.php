...
//    }else{
        ...
        $pdf->Cell(9, 6, 'R.B.', 'LR', 0, 'C');
        $pdf->Cell(15, 6, 'BRD', 'LR', 0, 'C');
        $pdf->Cell(80, 6, 'DJELATNIK', 'LR', 0, 'C');        
        $pdf->Cell(36, 6, 'JMBG', 'LR', 0, 'C');
...
//        if($row['ODJEL']===NULL){
        if(!empty($row)){
            ...
            $counter++;
            $pdf->Cell(9, 6, $counter, 'LRT', 0, 'C', 0, 0, 1);
            $pdf->Cell(15, 6, $row["BRD"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(80, 6, $row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(36, 6, $row["JMBG"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(40, 6, $row["statusi"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Ln(5);    
        }
//        }else{
