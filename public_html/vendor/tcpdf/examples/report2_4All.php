...
//            $pdf->Ln(5);
    $query = "SELECT IME, PREZIME, DZRO, DPRO, SSTAZDANI, SSTAZMJ, SSTAZGOD, DATUMR, nomtit.Ide as TITL, nomzan.NAZIV as ZANIMANJE, nomrm.NAZIV as RAM, nomskspr.NAZIV as SKASPR, nomss.NAZIV as SAS "
        ...
        . "LEFT JOIN nomss "
        . "ON djel.SS = nomss.ID "
        . "WHERE djel.klinika LIKE '%".$clinic['SIFRA']."%' AND djel.ODJEL IS NULL AND djel.ODSJEK IS NULL ".$where." ORDER BY nomrm.INDEX ";
    ...
    while($division = mysqli_fetch_assoc($divisionList)){
        ...
        . "LEFT JOIN nomss "
        . "ON djel.SS = nomss.ID "
        . "WHERE djel.ODJEL = '".$division['SIFRA']."' AND djel.ODSJEK IS NULL ".$where." ORDER BY nomrm.INDEX ";
