...
//    }else{
        ...
        $pdf->Cell(91, 5, 'DJELATNIK', 'LR', 0, 'C'); 
        $pdf->Cell(40, 5, '', 'LR', 0, 'C');
        $pdf->Cell(20, 5, 'OD', 'LR', 0, 'C');
        $pdf->Cell(20, 5, 'DO', 'LR', 0, 'C');       
...
//        if(!empty($row)){
            ...
            $counter++;
    $pdf->Cell(91, 5, ' '.$row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'L', 0, 0, 1);
    $pdf->Cell(40, 5, '', 'RT', 0, '', 0, 0, 1);
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
...
//        }
        ...
        if(mysqli_num_rows($resultodjel)===0){
            ...
            $pdf->Cell(180, 5, $rowodjel['NAZIV'], 'LRB', 0, 'C', $fill, 0, 0, 1);
            $pdf->Ln(5);
        }
    ...
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
//            $pdf->Cell(36, 6, $rowz["JMBG"], 'RT', 0, 'C', 0, 0, 1);
...
//                print_r($query);
            if(mysqli_num_rows($resultodsjek)===0){
                ...
                $pdf->Cell(180, 5, $rowodsjek['NAZIV'], 'LRB', 0, 'C', $fill, 0, 0, 1);
                $pdf->Ln(5);
            }
    ...
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
    $pdf->Cell(20, 5, '', 'RT', 0, '', 0, 0, 1);
//                $pdf->Cell(36, 6, $rowzy["JMBG"], 'RT', 0, 'C', 0, 0, 1);
