...
//    }else{
            ...
            $pdf->Cell(10, 5, 'R.B.', 'LRT', 0, 'C');
            $pdf->Cell(80, 5, 'DJELATNIK', 'LRT', 0, 'C');
            $pdf->Cell(30, 5, 'KOEFICIJENT', 'LRT', 0, 'C');
            $pdf->Cell(30, 5, 'UVJETI RADA', 'LRT', 0, 'C');
            $pdf->Cell(30, 5, 'UKUPNO', 'LRT', 0, 'C');      
