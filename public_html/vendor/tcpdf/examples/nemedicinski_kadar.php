...
$logoWidth = 55;
$title = 'POPIS NEMEDICINSKOG KADRA';
...
$pdf->Cell(8, 5, 'R.B.', 'LR', 0, 'L');
$pdf->Cell(64, 5, 'Ime i prezime', 'LR', 0, 'L');
$pdf->Cell(25, 5, 'Datum rođenja', 'LR', 0, 'L', 0, 0, 1);
$pdf->Cell(30, 5, 'Stručna sprema', 'LR', 0, 'L', 0, 0, 1);
$pdf->Cell(70, 5, 'Zanimanje', 'LR', 0, 'L');
$pdf->Cell(70, 5, 'Naziv radnog mjesta', 'LR', 0, 'L');
$pdf->Ln(5);
...
//            $pdf->Ln(5);
    ...
    while($row =  mysqli_fetch_assoc($clinicPeople)){
        ...
        $pdf->Cell(64, 5, $row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'L', 0, 0, 1);
        $pdf->Cell(25, 5, date2mysql($row["DATUMR"]), 'RT', 0, 'L', 0, 0, 1);
        $pdf->Cell(30, 5, $row["SAS"], 'RT', 0, 'L', 0, 0, 1);
        $pdf->Cell(70, 5, $row["ZANIMANJE"], 'RT', 0, 'L', 0, 0, 1);
