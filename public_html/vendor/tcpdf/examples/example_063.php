...
$query = "SELECT COUNT(*) as ukupno, "
        . "(SELECT COUNT(*) FROM djel t2 WHERE (t2.titula=42) AND (t2.status LIKE '01%') AND (t2.subspec1 = ".$spec["ID"]." or t2.subspec2 = ".$spec["ID"]." or t2.subspec3 = ".$spec["ID"].")) as prof, "
        . "(SELECT COUNT(*) FROM djel t3 WHERE (t3.titula=10) AND (t3.status LIKE '01%') AND (t3.subspec1 = ".$spec["ID"]." or t3.subspec2 = ".$spec["ID"]." or t3.subspec3 = ".$spec["ID"].")) as doc, "
        . "(SELECT COUNT(*) FROM djel t4 WHERE (t4.titula=12) AND (t4.status LIKE '01%') AND (t4.subspec1 = ".$spec["ID"]." or t4.subspec2 = ".$spec["ID"]." or t4.subspec3 = ".$spec["ID"].")) as dr, "
        . "(SELECT COUNT(*) FROM djel t5 WHERE (t5.titula=34) AND (t5.status LIKE '01%') AND (t5.subspec1 = ".$spec["ID"]." or t5.subspec2 = ".$spec["ID"]." or t5.subspec3 = ".$spec["ID"].")) as mr, "
        ...
        $pdf->Cell(10, 5, $row["nasubspec"], 'RT', 0, 'C', 0, 0, 1);
        $pdf->Cell(10, 5, $row["ukupno"], 'RT', 0, 'C', 0, 0, 1);
        $pdf->Ln(5);  
