...
if($_GET['get']==='izvjestaj'){
    include('db.php');
    $query= "SELECT * FROM djel";
...
$pdf->writeHTML($trz, true, false, true, false, '');
...
$try = '<h2>IZVJEŠTAJ</h2>
        <table border="1" cellpadding="1" width="750px">
        <tr>
            <th width="6%">R.B</th>
            <th>Djelatnik</th>
            <th>Ime Oca</th>
...
// output the HTML content
$pdf->writeHTML($try, true, false, true, false, '');
