...
//    }else{
        ...
        $pdf->Cell(83, 5, 'DJELATNIK', 'LR', 0, 'C');
        $pdf->Cell(87, 5, 'ZANIMANJE', 'LR', 0, 'C');
        $pdf->Cell(87, 5, 'RADNO MJESTO', 'LR', 0, 'C');
        $pdf->Ln(5);    
//    }
    ////////////////////////////////////////////////////////////////////////////
...
//        if(!empty($row)){
            ...
            $pdf->Cell(83, 5, $row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(87, 5, $row["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(87, 5, $row["RAM"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Ln(5);     
//        }
    }
...
//        }
        ...
        while($rowz = mysqli_fetch_assoc($resultodjel)){
            ...
            $counter++;
            $pdf->Cell(10, 5, $counter, 'LRT', 0, 'C', 0, 0, 1);
            $pdf->Cell(83, 5, $rowz["TITL"] . ' ' . $rowz["IME"] . ' ' . $rowz["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(87, 5, $rowz["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(87, 5, $rowz["RAM"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Ln(5);     
        }
...
//    }
            ...
            while($rowzy = mysqli_fetch_assoc($resultodsjek)){
                ...
                $counter++;
                $pdf->Cell(10, 5, $counter, 'LRT', 0, 'C', 0, 0, 1);
                $pdf->Cell(83, 5, $rowzy["TITL"] . ' ' . $rowzy["IME"] . ' ' . $rowzy["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(87, 5, $rowzy["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(87, 5, $rowzy["RAM"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Ln(5);
            }
        }
    }       
