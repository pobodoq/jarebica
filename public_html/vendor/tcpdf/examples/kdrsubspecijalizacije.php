...
while($spec = mysqli_fetch_assoc($result)){
        ...
        $q= "SELECT COUNT(*) FROM djel WHERE SUBSPEC1 = ".$spec["ID"]." AND (PODVRSTA = '0104') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
        $execute = execute($con, $q);
        $counters[0] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        $q= "SELECT COUNT(*) FROM djel WHERE SUBSPEC1 = ".$spec["ID"]." AND (PODVRSTA = '0104') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31') AND SPOL = 1";
        $execute = execute($con, $q);
        $counters[1] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        $q= "SELECT COUNT(*) FROM djel WHERE SUBSPEC1 = ".$spec["ID"]." AND (PODVRSTA = '0104') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31') AND SPOL = 2";
        $execute = execute($con, $q);
        $counters[2] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);

        
        $q= "SELECT COUNT(*) FROM djel WHERE NASUBSPEC = ".$spec["ID"]." AND (PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
        $execute = execute($con, $q);
        $counters[3] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        $q= "SELECT COUNT(*) FROM djel WHERE NASUBSPEC = ".$spec["ID"]." AND (PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31') AND SPOL = 1";
        $execute = execute($con, $q);
        $counters[4] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        $q= "SELECT COUNT(*) FROM djel WHERE NASUBSPEC = ".$spec["ID"]." AND (PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31') AND SPOL = 2";
        $execute = execute($con, $q);
        $counters[5] += $execute;
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        $pdf->Cell(10, 4, '', 'RT', 0, 'C', 0, 0, 1);
        $q= "SELECT COUNT(*) FROM djel WHERE (SUBSPEC1 = ".$spec["ID"]." OR NASUBSPEC = ".$spec["ID"].")  AND (PODVRSTA = '0104' OR PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
        $execute = execute($con, $q);
        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        $pdf->Ln(4);  
...
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104') AND (TITULA=42 OR TITULA = 40) AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104') AND (TITULA=10 OR TITULA = 36) AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104') AND (TITULA=12 OR TITULA = 13) AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104') AND (TITULA=34 OR TITULA = 32) AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
        
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        $pdf->Cell(10, 4, '', 'RT', 0, 'C', 0, 0, 1);
//        $q= "SELECT COUNT(*) FROM djel WHERE (PODVRSTA = '0104' OR PODVRSTA = '0105') AND ((STATUS LIKE '01%' AND DZRO < '2016-12-31') OR DPRO > '2016-12-31')";
//        $execute = execute($con, $q);
//        $pdf->Cell(10, 4, $execute, 'RT', 0, 'C', 0, 0, 1);
//        $pdf->Ln(4);
