...
$pdf->Cell(70, 5, 'JMBG', 'LR', 0, 'C');
$pdf->Cell(74, 5, 'RADNO MJESTO', 'LR', 0, 'C');
$pdf->Cell(35, 5, 'STRUČNA SPREMA', 'LR', 0, 'C', 0, 0, 1);
...
//            $pdf->Cell(267, 5, $clinic['NAZIV'], 'LR', 0, 'C', $fill, 0, 0, 1);
//            $pdf->Ln(5);
    $query = "SELECT IME, PREZIME, DZRO, JMBG, DPRO, SSTAZDANI, SSTAZMJ, SSTAZGOD, DATUMR, nomtit.Ide as TITL, nomzan.NAZIV as ZANIMANJE, nomrm.NAZIV as RAM, nomskspr.NAZIV as SKASPR, nomss.NAZIV as SAS "
        . "FROM djel "
        . "LEFT JOIN nomtit "
    ...
    while($row =  mysqli_fetch_assoc($clinicPeople)){
        ...
        $pdf->Cell(70, 5, $row["JMBG"], 'RT', 0, 'C', 0, 0, 1);
        $pdf->Cell(74, 5, $row["RAM"], 'RT', 0, 'C', 0, 0, 1);
        $pdf->Cell(35, 5, $row["SAS"], 'RT', 0, 'C', 0, 0, 1);
