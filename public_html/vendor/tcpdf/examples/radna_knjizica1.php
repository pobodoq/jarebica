...
//        while($fuckme = mysqli_fetch_assoc($checkNulls)){echo $fuckme['kaunt']; echo '<br/>';}
        if($checkNulls['kaunt']!=='0'){    
            ...
            $pdf->SetHeaderData($logo, $logoWidth, $title, $clinic['NAZIV']);
            $pdf->AddPage('P', 'A4');
...
//        $pdf->Ln(10);  
        $pdf->Cell(180, 6, 'Broj: 10', '', 0, '', 0, 0, 1);
        $pdf->Ln(5);  
        ...
        $pdf->Cell(180, 6, 'Predmet: Obavijest o vraćanju rande knjižice, ', '', 0, '', 0, 0, 1);
        $pdf->Ln(5);  
        ...
        $pdf->SetFont('dejavusans', '', 11);
        $pdf->Cell(20, 6, '', '', 0, '', 0, 0, 1);
        $pdf->Cell(160, 6, 'Sukladno članku 176. Zakona o radu ("Službene novine Federacije BiH", broj: 26/16), ', '', 0, '', 0, 0, 1);
        $pdf->Ln(5);  
        $pdf->Cell(180, 6, 'odredbe čl. 163.-165., koje su se odnosile na radnu knjižicu, prestaju da važe zaključno sa ', '', 0, '', 0, 0, 1);
        $pdf->Ln(5);  
        $pdf->Cell(180, 6, 'danom 30.06.2016. godine. ', '', 0, '', 0, 0, 1);
        $pdf->Ln(10);  
        $pdf->Cell(20, 6, '', '', 0, '', 0, 0, 1);
        ...
        $pdf->Cell(60, 6, 'Ravnatelj SKB Mostar  ', '', 0, '', 0, 0, 1);
        $pdf->Ln(10);  
