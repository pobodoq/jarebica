...
//        $pdf->resetHeaderTemplate();
        ...
        $pdf->Cell(70, 5, 'ZANIMANJE', 'LR', 0, 'C');
        $pdf->Cell(10, 5, 'BRD', 'LR', 0, 'C');
...
while($row =  mysqli_fetch_assoc($result)){
    ...
    $pdf->Cell(70, 5, $row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
    $pdf->Cell(70, 5, $row["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
    $pdf->Cell(10, 5, $row["BRD"], 'RT', 0, 'C', 0, 0, 1);
