...
//    }else{
        ...
        $pdf->Cell(75, 5, 'DJELATNIK', 'LR', 0, 'C');
        $pdf->Cell(75, 5, 'ZANIMANJE', 'LR', 0, 'C');
        $pdf->Cell(21, 5, 'STAZ(g,m,d)', 'LR', 0, 'C', 0, 0, 1);
        $pdf->Ln(5);    
//    }
    ////////////////////////////////////////////////////////////////////////////
...
//        if(!empty($row)){
            ...
            $pdf->Cell(75, 5, $row["TITL"] . ' ' . $row["IME"] . ' ' . $row["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(75, 5, $row["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
...
//        }
        ...
        while($rowz = mysqli_fetch_assoc($resultodjel)){
            ...
            $counter++;
            $pdf->Cell(9, 5, $counter, 'LRT', 0, 'C', 0, 0, 1);
            $pdf->Cell(75, 5, $rowz["TITL"] . ' ' . $rowz["IME"] . ' ' . $rowz["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(75, 5, $rowz["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[2], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[1], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[0], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Ln(5);     
...
//                print_r($query);
            ...
            while($rowzy = mysqli_fetch_assoc($resultodsjek)){
                ...
                $counter++;
            $pdf->Cell(9, 5, $counter, 'LRT', 0, 'C', 0, 0, 1);
            $pdf->Cell(75, 5, $rowzy["TITL"] . ' ' . $rowzy["IME"] . ' ' . $rowzy["PREZIME"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(75, 5, $rowzy["ZANIMANJE"], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[2], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[1], 'RT', 0, 'C', 0, 0, 1);
            $pdf->Cell(7, 5, $urs[0], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Ln(5);     
