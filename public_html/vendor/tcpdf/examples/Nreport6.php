...
//    $null = NULL;
    ...
    $query = "SELECT *, nomtit.IDe as TITL, nomzan.NAZIV as ZANIMANJE, nomrm.NAZIV as RAM, nomskspr.NAZIV as SKASPR, nomss.NAZIV as SAS "
            ...
            . "WHERE klinika = '".$rowklinika['SIFRA']."' ".$where." ORDER BY nomrm.INDEX ASC";
//    print_r($query);
...
//            if($rowz['ODSJEK']===NULL){
            ...
            $counter++;
                ...
                $pdf->Cell(25, 5, $rowz["OTAC"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(36, 5, $rowz["JMBG"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(30, 5, date2mysql($rowz["DATUMR"]), 'RT', 0, 'C', 0, 0, 1);
            $pdf->Ln(5);   
//            }else{
...
//            }else{
                $pdf->Cell(170, 5, $rowodsjek['NAZIV'], 'LR', 0, 'C', $fill, 0, 0, 1);
                $pdf->Ln(5);
//            }
            while($rowzy = mysqli_fetch_assoc($resultodsjek)){
                ...
                $pdf->Cell(25, 5, $rowzy["OTAC"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(36, 5, $rowzy["JMBG"], 'RT', 0, 'C', 0, 0, 1);
                $pdf->Cell(30, 5, date2mysql($rowzy["DATUMR"]), 'RT', 0, 'C', 0, 0, 1);
                $pdf->Ln(5);     
            }
        }
//            }
