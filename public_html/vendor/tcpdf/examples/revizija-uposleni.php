...
//            $pdf->setCellMargins(0, 0, 0, 0);
            ...
            $pdf->Cell(227, 5, 'Pregled uposlenika sa kojima je zasnovan radni odnos u periodu od ' . $_GET['oddzro'] . '-' .$_GET['dodzro'] .'. godine');
            $pdf->Ln(5);
            ...
            $pdf->Cell(28, 5, 'Datum zasnivanja', 'LR', 0, 'C', $fill, 0, 0, 1);  
            $pdf->Cell(55, 5, 'Vrsta ugovora ', 'LR', 0, 'C', $fill, 0, 0, 1);
            $pdf->Cell(55, 5, 'Način prijema uposlenika', 'LR', 0, 'C', $fill, 0, 0, 1);
...
//            $pdf->Cell(18, 5, 'DATUMR', 'LR', 0, 'C', 0, 0, 1);
            ...
            $pdf->Cell(55, 5, '', 'LR', 0, 'C', $fill, 0, 0, 1);
            $pdf->Ln(5);
...
//        $urs = rs($row['DZRO'], $row['DPRO'], $row['SSTAZDANI'], $row['SSTAZMJ'], $row['SSTAZGOD']);
        ...
        $pdf->Cell(28, 5, date2mysql($row["DZRO"]), 'RT', 0, 'C', 0, 0, 1);
        if(substr($row["STATUS"], 0, 4)==='0102'){
            ...
            $pdf->Cell(55, 5, "", 'RT', 0, 'C', 0, 0, 1);
//        $pdf->Cell(55, 5, $row["STATUS"], 'RT', 0, 'C', 0, 0, 1);
