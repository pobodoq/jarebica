...
$query = "SELECT IME, PREZIME, OTAC, DATUMR, SSTAZDANI, SSTAZMJ, SSTAZGOD, DZRO, DPRO, nomtit.IDe AS TITULA, nomrm.NAZIV AS RM, nomzan.NAZIV AS ZANIMANJE, nomskspr.NAZIV AS SKSP, nomss.NAZIV AS SS, kbodjeli.NAZIV AS ODJEL "
        . "FROM djel "
        . "LEFT JOIN nomtit "
...
$counter=0;
    ...
    $pdf->Cell(40, 6, 'DJELATNIK', 'LR', 0, 'C');
...
while($row =  mysqli_fetch_assoc($result)){    
    ...
    $pdf->Cell(40, 6, $row["TITULA"] . ' ' . $row["IME"]. ' '. $row["PREZIME"], 'LRT', 0, 'C', 0, 0, 1);
